...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/MICO_MARIOPACK\Src\KoopaHackBody_alb.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3924632918</m_ExportedTime>
	<m_ClassName text="Leader_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="KoopaHackBody_alb.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="KoopaHackBody_alb"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
