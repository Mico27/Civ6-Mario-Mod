...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/MICO_MARIOPACK\Src\KoopaHackBody_nrm.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>4121727853</m_ExportedTime>
	<m_ClassName text="Leader_Normal"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="KoopaHackBody_nrm.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="KoopaHackBody_nrm"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
